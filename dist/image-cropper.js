  ...
  function cropImage(file) {
    return new Promise((resolve, reject) => {
      ...
      const finish = () => {
        ...
        canvas.getContext('2d').drawImage(image, sourceX, sourceY, cropWidth, cropHeight, 0, 0, outputSize, outputSize);
        canvas.toBlob(blob => {
      ...
      image.addEventListener('load', () => { dialog.showModal(); requestAnimationFrame(initialise); }, { once: true });
      image.src = objectUrl;
    });
  }
